	 ...
	 <div id="wrap">
        ...
        <div id="container">
            <div class="con_in">
                ...
                <div class="top_title">
                    <p><textarea style="resize: none;" name="p_title" id="title_text" placeholder="제목"></textarea></p>
                </div>
                </div> <!--.top-->
                <div class="write">
                    <button>본문 이미지 첨부</button>
                    <p><textarea style="resize: none;" name="p_content" id="input_text" placeholder="내용"></textarea></p>
                </div>
            </div>
        </div>
        </form>
