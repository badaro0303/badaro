	...
	<div id="wrap">
        <div class="join">
            ...
            <div class="provision">
                ...
                <br>
                <span class="title">1. 수집하는 개인정보</span><br>
                이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 바다로 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, 바다로는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.<br>
                <br>
                회원가입 시점에 바다로가 이용자로부터 수집하는 개인정보는 아래와 같습니다.<br>
                ...
                바다로 내의 개별 서비스 이용, 이벤트 응모 및 경품 신청 과정에서 해당 서비스의 이용자에 한해 추가 개인정보 수집이 발생할 수 있습니다. 추가로 개인정보를 수집할 경우에는 해당 개인정보 수집 시점에서 이용자에게 ‘수집하는 개인정보 항목, 개인정보의 수집 및 이용목적, 개인정보의 보관기간’에 대해 안내 드리고 동의를 받습니다.<br>
                <br>
                ...
                바다로에서 제공하는 위치기반 서비스에 대해서는 '바다로 위치정보 이용약관'에서 자세하게 규정하고 있습니다.<br>
                이와 같이 수집된 정보는 개인정보와의 연계 여부 등에 따라 개인정보에 해당할 수 있고, 개인정보에 해당하지 않을 수도 있습니다.<br>
                <br>
                <span class="title">2. 수집한 개인정보의 이용</span><br>
                바다로 및 바다로 관련 제반 서비스(모바일 웹/앱 포함)의 회원관리, 서비스 개발・제공 및 향상, 안전한 인터넷 이용환경 구축 등 아래의 목적으로만 개인정보를 이용합니다.<br>
                <br>
                ...
                - 법령 및 바다로 이용약관을 위반하는 회원에 대한 이용 제한 조치, 부정 이용 행위를 포함하여 서비스의 원활한 운영에 지장을 주는 행위에 대한 방지 및 제재, 계정도용 및 부정거래 방지, 약관 개정 등의 고지사항 전달, 분쟁조정을 위한 기록 보존, 민원처리 등 이용자 보호 및 서비스 운영을 위하여 개인정보를 이용합니다.<br>
                ...
                <span class="title">3. 개인정보의 보관기간</span><br>
                ...
                - 바다로 플러스 멤버십 서비스 혜택 중복 제공 방지<br>
                ...
                전자상거래 등에서의 소비자 보호에 관한 법률, 전자금융거래법, 통신비밀보호법 등 법령에서 일정기간 정보의 보관을 규정하는 경우는 아래와 같습니다. 바다로는 이 기간 동안 법령의 규정에 따라 개인정보를 보관하며, 본 정보를 다른 목적으로는 절대 이용하지 않습니다.<br>
                ...
                로그인 기록: 3개월<br>
                <br>
                참고로 바다로는 ‘개인정보 유효기간제’에 따라 1년간 서비스를 이용하지 않은 회원의 개인정보를 별도로 분리 보관하여 관리하고 있습니다.<br>
                <br>
                <span class="title">4. 개인정보 수집 및 이용 동의를 거부할 권리</span><br>
                이용자는 개인정보의 수집 및 이용 동의를 거부할 권리가 있습니다. 회원가입 시 수집하는 최소한의 개인정보, 즉, 필수 항목에 대한 수집 및 이용 동의를 거부하실 경우, 회원가입이 어려울 수 있습니다.<br>
            </div>
            <div class="agree">
                <label for=""><input type="radio" name="radio">약관동의</label>
                <label for=""><input type="radio" name="radio">약관거부</label>
            </div>
            ...
            <form action="join" method="post">
                ...
                <label for="pw2">비밀번호<br>확인</label>
                <input type="password" id="pw2" name="pw2" placeholder="비밀번호를 재확인하세요.">
				<div class="eheck_font" id="pw2_check"></div>

                <br>
                
                <label for="name">성명</label>
                <input type="text" id="name" name="name" placeholder="성명을 입력하세요.">
                <div class="eheck_font" id="name_check"></div>
                <br>
                
                <label for="birth">생년월일</label>
                <input type="text" id="birth" name="birth" placeholder="생년월일 8자">
                <div class="eheck_font" id="birth_check"></div>
                
                <br>
                
                <label for="phone">전화번호</label>
                <input type="tel" id="phone" name="phone" placeholder="'-' 를 빼고 입력하세요.">
